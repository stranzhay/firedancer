#ifndef HEADER_fd_src_flamenco_sysvar_epoch_schedule_h
#define HEADER_fd_src_flamenco_sysvar_epoch_schedule_h
...
#endif /* HEADER_fd_src_flamenco_sysvar_epoch_schedule_h */
